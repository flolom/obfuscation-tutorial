...
import com.worldline.techforum.obfuscation.api.internal.model.GsonAdaptersSession;
import com.worldline.techforum.obfuscation.api.internal.model.GsonAdaptersWhen;
import com.worldline.techforum.obfuscation.api.internal.model.ImmutableSession;
...
public class TechForumApiImpl implements TechForumApi {
    ...
    public TechForumApiImpl(HttpUrl baseUrl, Context context) {
        ...
        // register the generated TypeAdapterFactory, so this gson instance will be able to
        // (de)serialize the classes generated by Immutables.
        Gson gson = new GsonBuilder()
                .registerTypeAdapterFactory(new GsonAdaptersSession())
                .registerTypeAdapterFactory(new GsonAdaptersWhen())
                .create();
        ...
        localRepository = new TalkLocalRepository(context, gson);
    }
